...
def includeMessages = [
  "[WARNING] Found duplicate and different resources in [com.ning.maven.plugins.duplicate-finder-maven-plugin:first-jar:1.0,com.ning.maven.plugins.duplicate-finder-maven-plugin:test-resource-conflict-test-testpath:1.0.under-test]"
]
